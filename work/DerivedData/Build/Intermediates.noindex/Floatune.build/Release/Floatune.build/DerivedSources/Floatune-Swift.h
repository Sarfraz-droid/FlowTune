...
#ifndef FLOATUNE_SWIFT_H
#define FLOATUNE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Floatune",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Floatune11AppDelegate")
...
@class NSWindow;
SWIFT_CLASS("_TtC8Floatune23FloatingPanelController")
@interface FloatingPanelController : NSObject <NSWindowDelegate>
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC8Floatune14RecorderButton")
@interface RecorderButton : NSButton
